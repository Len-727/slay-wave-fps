...
//  Game.h ? Game�N���X��`
//
//  Gothic Swarm �̃��C���N���X�B
//  DirectX 11�f�o�C�X�̊Ǘ��A�Q�[�����[�v�̐���A
//  �S�T�u�V�X�e���̓�����S������B
//
//  �y�t�@�C���\���z
//  ������8��.cpp�t�@�C���ɕ�������Ă���F
//    GameCore.cpp    ? ������ / Tick / ���\�[�X�쐬
//    GamePlay.cpp    ? �Q�[���v���C���W�b�N
//    GameRender.cpp  ? 3D�`��p�C�v���C��
//    GameScene.cpp   ? �V�[���Ǘ��i�^�C�g��/GO/�����L���O�j
//    GameHUD.cpp     ? HUD�`��
//    GamePhysics.cpp ? Bullet Physics����
//    GameSlice.cpp   ? ���b�V���ؒf / ���Е���
//    GameDebug.cpp   ? �f�o�b�OUI�iImGui�j
// ============================================================
#pragma once
...
// -----------------------------------------------
//  Effekseer�i�p�[�e�B�N���G�t�F�N�g�j
// -----------------------------------------------
#include <Effekseer.h>
#include <EffekseerRendererDX11.h>

// -----------------------------------------------
//  Dear ImGui�i�f�o�b�OUI�j
// -----------------------------------------------
#include <imgui.h>
...
private:
    ...
    static constexpr float MAP_SCALE = 0.4f;  // �}�b�v�̑傫���i1.0 = �����j
    ...
    // --- 3D���f�� ---
    std::unique_ptr<Model> m_weaponModel;          // ����
    ...
    std::unique_ptr<Model> m_testModel;             // �e�X�g�p
    std::unique_ptr<Model> m_pistolModel;           // �Ǖ���: �s�X�g��
    std::unique_ptr<Model> m_shotgunModel;          // �Ǖ���: �V���b�g�K��
    std::unique_ptr<Model> m_rifleModel;            // �Ǖ���: ���C�t��
    std::unique_ptr<Model> m_sniperModel;           // �Ǖ���: �X�i�C�p�[
    std::unique_ptr<Model> m_gloryKillArmModel;     // �O���[���[�L��: �r
    std::unique_ptr<Model> m_gloryKillKnifeModel;   // �O���[���[�L��: �i�C�t
    WeaponSpawn* m_nearbyWeaponSpawn = nullptr;     // �߂��̕Ǖ���i�񏊗L�|�C���^�j
    ...
    float m_parryCooldown = 0.0f;   // �p���B�N�[���_�E���c�莞��
    static constexpr float PARRY_COOLDOWN = 0.4f;   // �p���B��̍ăp���B�s����
